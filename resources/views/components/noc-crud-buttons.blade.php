{{-- Komponen Tombol CRUD untuk NOC Management --}}
<div class="flex space-x-2 items-center">
    ...
    {{-- Tombol Edit --}}
    <a href="{{ $editRoute ?? '#' }}" 
       class="inline-flex items-center px-3 py-1.5 bg-yellow-500 hover:bg-yellow-600 text-gray-900 text-xs font-medium rounded-lg transition-colors duration-200">
        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
