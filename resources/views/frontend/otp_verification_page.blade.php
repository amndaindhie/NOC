...
<div class="container py-5 d-flex justify-content-center align-items-center min-vh-100">
    <div>
        ...
        <form class="otp-Form" id="otp-form" method="POST" action="{{ route('verification.otp.verify') }}">
            ...
            <p class="otpSubheading">Enter the 6-digit OTP sent to your email</p>
            ...
            <p class="resendNote mt-3 text-center">
        ...
        <!-- Hidden Resend Form -->
        <form id="resend-form" method="POST" action="{{ route('verification.otp.resend') }}" class="d-none">
            @csrf
            ...
            fetch(resendForm.action, {
                ...
                .then(data => {
                    otpMessage.innerHTML = data.success ?
                        ...
                        '<div class="alert alert-danger">' + (data.message || 'Failed to send OTP') + '</div>';
                })
                .catch(() => {
                    otpMessage.innerHTML =
                        '<div class="alert alert-danger">An error occurred. Please try again.</div>';
