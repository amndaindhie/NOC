...
<head>
    <meta charset="UTF-8">
    <title>Complaint Submission Notification</title>
</head>
                ...
                <table width="600" border="0" cellspacing="0" cellpadding="0" style="background:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 2px 6px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td align="center" bgcolor="#1e4356" style="padding:20px;">
                            <h1 style="color:#ffffff; margin:0; font-size:22px;">Complaint Notification</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:30px; color:#333333; font-size:15px; line-height:1.6;">
                            <p>Hello,</p>
                            <p>Your complaint submission with ticket number <strong>{{ $complaint->nomor_tiket }}</strong> has been successfully received.</p>
                            ...
                            <table width="100%" cellpadding="8" cellspacing="0" border="0" style="border:1px solid #e0e0e0; border-radius:6px; margin-top:10px; margin-bottom:20px; font-size:14px;">
                                <tr style="background-color:#f9f9f9;">
                                    ...
                                    <td>{{ $complaint->nama_tenant }}</td>
                                </tr>
                                <tr>
                                    <td><strong>Contact Person</strong></td>
                                    <td>{{ $complaint->kontak_person }}</td>
                                </tr>
                                <tr style="background-color:#f9f9f9;">
                                    <td><strong>Disruption Type</strong></td>
                                    <td>{{ $complaint->jenis_gangguan }}</td>
                                </tr>
                                <tr>
                                    <td><strong>Start Time</strong></td>
                                    <td>{{ $complaint->waktu_mulai_gangguan }}</td>
                                </tr>
                                <tr style="background-color:#f9f9f9;">
                                    <td><strong>Description</strong></td>
                                    <td>{{ $complaint->deskripsi_gangguan }}</td>
                                </tr>
                                <tr>
                            ...
                            <p>Our team will follow up on your complaint as soon as possible and work to resolve the issue quickly.</p>
                            <p>Thank you for reporting this issue to us.</p>
                        </td>
                    </tr>
