<x-layouts.admin title="NOC - Keluhan">
    <div class="mb-6">
        <h2 class="text-2xl font-semibold">NOC - Keluhan</h2>
        <p class="text-gray-600 dark:text-gray-400">Kelola semua keluhan jaringan dari tenant.</p>
    </div>

    <div class="bg-white dark:bg-gray-800 rounded-lg shadow mb-4">
        <div class="px-6 py-4 flex justify-between items-center">
            <h3 class="text-lg font-semibold">Daftar Keluhan</h3>
            <div class="flex space-x-2">
                <div class="relative">
                    <input type="text" placeholder="Search keluhan..."
                ...
                <div class="flex space-x-2">
                    <a href="{{ route('admin.noc.keluhan.export.excel') }}" class="btn-secondary flex items-center">
                    ...
                    <a href="{{ route('admin.noc.keluhan.export.csv') }}" class="btn-secondary flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    ...
                    <a href="{{ route('admin.noc.keluhan.create') }}" class="btn-primary flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="p-6">
                        ...
                        <table
                            ...
                            <thead class="bg-gray-100 dark:bg-gray-700">
                                <tr
                                    ...
                                    <th class="px-3 py-3 text-left">Jenis Keluhan</th>
                                    <th class="px-3 py-3">Tingkat Urgensi</th>
                                    <th class="px-3 py-3">Tanggal Lapor</th>
                                    <th class="px-3 py-3">Status</th>
                                    <th class="px-3 py-3">Actions</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse($keluhan as $request)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-750 transition">
                                        ...
                                        <td class="px-3 py-2 text-left">{{ $request->jenis_gangguan }}</td>
                            ...
                            {{ $request->status == 'Ditolak' ? 'bg-red-100 text-red-800' : '' }}">
                                        ...
                                        <td class="px-3 py-2 text-center whitespace-nowrap">
                                            <x-noc-crud-buttons :viewRoute="route('admin.noc.keluhan.show', $request->id)" :editRoute="route('admin.noc.keluhan.edit', $request->id)" :deleteRoute="route('admin.noc.keluhan.destroy', $request->id)" />
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                    ...
                    <div class="mt-6 flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
                        <div class="text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <span class="font-medium">{{ $keluhan->count() }}</span> of
                            <span class="font-medium">{{ $keluhan->total() }}</span> results
                        </div>
