<x-layouts.frontend title="Tambah Maintenance">
    <div class="mb-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        <div class="p-6">
            ...
            <form action="{{ route('noc.maintenance.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                
                <input type="hidden" name="nomor_tracking" id="nomor_tracking">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="tanggal_permintaan" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tanggal Permintaan</label>
                ...
                <div class="mt-6 flex space-x-3">
                    ...
                    <a href="{{ route('welcome') }}" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-md">
                        Batal
                    </a>
                </div>
            </form>
